...
<html lang="zh-Hant-TW">
    <head>
        ...
        <link media="all" type="text/css" rel="stylesheet" href="//fonts.googleapis.com/css?family=Roboto:400,300">
        <style>
            body {
                /*padding-top: 70px;*/
                height: auto;
                background: url('{{ asset('img/index_background.png') }}');
    ...
    <body>
        ...
        <div class="ui inverted center aligned segment footer">
            <div class="ui container center aligned">
                <p>
                    &copy;2016 Vongola. All rights reserved. |
                    <a href="{{ route('auth.login') }}">Manager Login</a>
                </p>
            </div>
        </div>
